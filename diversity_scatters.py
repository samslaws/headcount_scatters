...
pd.read_csv('headcount_data.csv, index=False')

df = df[df.firm_auto_namenid != 'test']
df = df.fillna(0)

df['total_hc1'] = df['hc1_part_male_hisp'] + df['hc1_part_male_black'] + df['hc1_part_male_asian'] + df['hc1_part_male_white'] + df['hc1_part_male_pi'] + df['hc1_part_male_nata'] + df['hc1_part_male_tomr'] + df['hc1_part_male_norace'] + df['hc1_part_fem_hisp'] + df['hc1_part_fem_black'] + df['hc1_part_fem_asian'] + df['hc1_part_fem_white'] + df['hc1_part_fem_pi'] + df['hc1_part_fem_nata'] + df['hc1_part_fem_tomr'] + df['hc1_part_fem_norace'] + df['hc1_part_nb_hisp'] + df['hc1_part_nb_black'] +
df['hc1_part_nb_asian'] + df['hc1_part_nb_white'] +df['hc1_part_nb_pi'] + df['hc1_part_nb_nata'] +df['hc1_part_nb_tomr'] + df['hc1_part_nb_norace'] +df['hc1_part_nogen_hisp'] + df['hc1_part_nogen_black'] +df['hc1_part_nogen_asian'] + df['hc1_part_nogen_white'] +df['hc1_part_nogen_pi'] + df['hc1_part_nogen_nata'] + df['hc1_part_nogen_tomr'] + df['hc1_part_nogen_norace'] +df['hc1_eq_male_hisp'] + df['hc1_eq_male_black'] +df['hc1_eq_male_asian'] + df['hc1_eq_male_white'] +df['hc1_eq_male_pi'] +
df['hc1_eq_male_nata'] + df['hc1_eq_male_tomr'] + df['hc1_eq_male_norace'] +df['hc1_eq_fem_hisp'] + df['hc1_eq_fem_black'] +df['hc1_eq_fem_asian'] + df['hc1_eq_fem_white'] +df['hc1_eq_fem_pi'] + df['hc1_eq_fem_nata'] +df['hc1_eq_fem_tomr'] + df['hc1_eq_fem_norace'] +df['hc1_eq_nb_hisp'] + df['hc1_eq_nb_black'] +df['hc1_eq_nb_asian'] + df['hc1_eq_nb_white'] +df['hc1_eq_nb_pi'] + df['hc1_eq_nb_nata'] +df['hc1_eq_nb_tomr'] + df['hc1_eq_nb_norace'] +df['hc1_eq_nogen_hisp'] +
df['hc1_eq_nogen_black'] +df['hc1_eq_nogen_asian'] + df['hc1_eq_nogen_white'] +df['hc1_eq_nogen_pi'] + df['hc1_eq_nogen_nata'] +df['hc1_eq_nogen_tomr'] + df['hc1_eq_nogen_norace'] + df['hc1_noneq_male_hisp'] + df['hc1_noneq_male_black'] + df['hc1_noneq_male_asian'] + df['hc1_noneq_male_white'] +df['hc1_noneq_male_pi'] + df['hc1_noneq_male_nata'] + df['hc1_noneq_male_tomr'] + df['hc1_noneq_male_norace'] +df['hc1_noneq_fem_hisp'] + df['hc1_noneq_fem_black'] + df['hc1_noneq_fem_asian'] +
df['hc1_noneq_fem_white'] +df['hc1_noneq_fem_pi'] + df['hc1_noneq_fem_nata'] +df['hc1_noneq_fem_tomr'] + df['hc1_noneq_fem_norace'] + df['hc1_noneq_nb_hisp'] + df['hc1_noneq_nb_black'] +df['hc1_noneq_nb_asian'] + df['hc1_noneq_nb_white'] +df['hc1_noneq_nb_pi'] + df['hc1_noneq_nb_nata'] + df['hc1_noneq_nb_tomr'] + df['hc1_noneq_nb_norace'] +df['hc1_noneq_nogen_hisp'] + df['hc1_noneq_nogen_black'] +df['hc1_noneq_nogen_asian'] + df['hc1_noneq_nogen_white'] +df['hc1_noneq_nogen_pi'] +
df['hc1_noneq_nogen_nata'] +df['hc1_noneq_nogen_tomr'] + df['hc1_noneq_nogen_norace'] + df['hc1_other_male_hisp'] + df['hc1_other_male_black'] + df['hc1_other_male_asian'] + df['hc1_other_male_white'] + df['hc1_other_male_pi'] + df['hc1_other_male_nata'] + df['hc1_other_male_tomr'] + df['hc1_other_male_norace'] + df['hc1_other_fem_hisp'] + df['hc1_other_fem_black'] + df['hc1_other_fem_asian'] + df['hc1_other_fem_white'] + df['hc1_other_fem_pi'] + df['hc1_other_fem_nata'] +
df['hc1_other_fem_tomr'] + df['hc1_other_fem_norace'] + df['hc1_other_nb_hisp'] + df['hc1_other_nb_black'] + df['hc1_other_nb_asian'] + df['hc1_other_nb_white'] + df['hc1_other_nb_pi'] + df['hc1_other_nb_nata'] + df['hc1_other_nb_tomr'] + df['hc1_other_nb_norace'] + df['hc1_other_nogen_hisp'] + df['hc1_other_nogen_black'] +df['hc1_other_nogen_asian'] + df['hc1_other_nogen_white'] +df['hc1_other_nogen_pi'] + df['hc1_other_nogen_nata'] +df['hc1_other_nogen_tomr'] + df['hc1_other_nogen_norace']
+ df['hc1_assoc_male_hisp'] + df['hc1_assoc_male_black'] + df['hc1_assoc_male_asian'] + df['hc1_assoc_male_white'] +df['hc1_assoc_male_pi'] + df['hc1_assoc_male_nata'] + df['hc1_assoc_male_tomr'] + df['hc1_assoc_male_norace'] + df['hc1_assoc_fem_hisp'] + df['hc1_assoc_fem_black'] + df['hc1_assoc_fem_asian'] + df['hc1_assoc_fem_white'] + df['hc1_assoc_fem_pi'] + df['hc1_assoc_fem_nata'] + df['hc1_assoc_fem_tomr'] + df['hc1_assoc_fem_norace'] + df['hc1_assoc_nb_hisp'] + df['hc1_assoc_nb_black'] +
df['hc1_assoc_nb_asian'] + df['hc1_assoc_nb_white'] + df['hc1_assoc_nb_pi'] + df['hc1_assoc_nb_nata'] +df['hc1_assoc_nb_tomr'] + df['hc1_assoc_nb_norace'] + df['hc1_assoc_nogen_hisp'] + df['hc1_assoc_nogen_black'] + df['hc1_assoc_nogen_asian'] + df['hc1_assoc_nogen_white'] +df['hc1_assoc_nogen_pi'] + df['hc1_assoc_nogen_nata'] + df['hc1_assoc_nogen_tomr'] + df['hc1_assoc_nogen_norace']

df['total_diversity_hc1'] = df['hc1_part_male_hisp'] + df['hc1_part_male_black'] + df['hc1_part_male_asian'] + df['hc1_part_male_pi'] + df['hc1_part_male_nata'] + df['hc1_part_male_tomr'] + df['hc1_part_fem_hisp'] + df['hc1_part_fem_black'] + df['hc1_part_fem_asian'] + df['hc1_part_fem_pi'] + df['hc1_part_fem_nata'] + df['hc1_part_fem_tomr'] + df['hc1_part_nb_hisp'] + df['hc1_part_nb_black'] + df['hc1_part_nb_asian'] + df['hc1_part_nb_pi'] + df['hc1_part_nb_nata'] +df['hc1_part_nb_tomr'] +
df['hc1_part_nogen_hisp'] + df['hc1_part_nogen_black'] +df['hc1_part_nogen_asian'] + df['hc1_part_nogen_pi'] + df['hc1_part_nogen_nata'] + df['hc1_part_nogen_tomr'] + df['hc1_eq_male_hisp'] + df['hc1_eq_male_black'] + df['hc1_eq_male_asian'] + df['hc1_eq_male_pi'] + df['hc1_eq_male_nata'] + df['hc1_eq_male_tomr'] + df['hc1_eq_fem_hisp'] + df['hc1_eq_fem_black'] + df['hc1_eq_fem_asian'] + df['hc1_eq_fem_pi'] + df['hc1_eq_fem_nata'] + df['hc1_eq_fem_tomr'] + df['hc1_eq_nb_hisp'] +
df['hc1_eq_nb_black'] + df['hc1_eq_nb_asian'] + df['hc1_eq_nb_pi'] + df['hc1_eq_nb_nata'] + df['hc1_eq_nb_tomr'] + df['hc1_eq_nogen_hisp'] + df['hc1_eq_nogen_black'] + df['hc1_eq_nogen_asian'] + df['hc1_eq_nogen_pi'] + df['hc1_eq_nogen_nata'] + df['hc1_eq_nogen_tomr'] + df['hc1_noneq_male_hisp'] + df['hc1_noneq_male_black'] + df['hc1_noneq_male_asian'] + df['hc1_noneq_male_pi'] + df['hc1_noneq_male_nata'] + df['hc1_noneq_male_tomr'] + df['hc1_noneq_fem_hisp'] + df['hc1_noneq_fem_black'] +
df['hc1_noneq_fem_asian'] + df['hc1_noneq_fem_pi'] + df['hc1_noneq_fem_nata'] +df['hc1_noneq_fem_tomr'] + df['hc1_noneq_nb_hisp'] + df['hc1_noneq_nb_black'] + df['hc1_noneq_nb_asian'] + df['hc1_noneq_nb_pi'] + df['hc1_noneq_nb_nata'] + df['hc1_noneq_nb_tomr'] + df['hc1_noneq_nogen_hisp'] + df['hc1_noneq_nogen_black'] +df['hc1_noneq_nogen_asian'] + df['hc1_noneq_nogen_pi'] + df['hc1_noneq_nogen_nata'] + df['hc1_noneq_nogen_tomr'] + df['hc1_other_male_hisp'] + df['hc1_other_male_black'] +
df['hc1_other_male_asian'] + df['hc1_other_male_pi'] + df['hc1_other_male_nata'] + df['hc1_other_male_tomr'] + df['hc1_other_fem_hisp'] + df['hc1_other_fem_black'] + df['hc1_other_fem_asian'] + df['hc1_other_fem_pi'] + df['hc1_other_fem_nata'] + df['hc1_other_fem_tomr'] + df['hc1_other_nb_hisp'] + df['hc1_other_nb_black'] + df['hc1_other_nb_asian'] + df['hc1_other_nb_pi'] + df['hc1_other_nb_nata'] + df['hc1_other_nb_tomr'] + df['hc1_other_nogen_hisp'] + df['hc1_other_nogen_black'] +
df['hc1_other_nogen_asian'] + df['hc1_other_nogen_pi'] + df['hc1_other_nogen_nata'] + df['hc1_other_nogen_tomr'] + df['hc1_assoc_male_hisp'] + df['hc1_assoc_male_black'] + df['hc1_assoc_male_asian'] + df['hc1_assoc_male_pi'] + df['hc1_assoc_male_nata'] + df['hc1_assoc_male_tomr'] + df['hc1_assoc_fem_hisp'] + df['hc1_assoc_fem_black'] + df['hc1_assoc_fem_asian'] + df['hc1_assoc_fem_pi'] + df['hc1_assoc_fem_nata'] + df['hc1_assoc_fem_tomr'] + df['hc1_assoc_nb_hisp'] + df['hc1_assoc_nb_black'] +
df['hc1_assoc_nb_asian'] + df['hc1_assoc_nb_pi'] + df['hc1_assoc_nb_nata'] +df['hc1_assoc_nb_tomr'] + df['hc1_assoc_nogen_hisp'] + df['hc1_assoc_nogen_black'] + df['hc1_assoc_nogen_asian'] + df['hc1_assoc_nogen_pi'] + df['hc1_assoc_nogen_nata'] + df['hc1_assoc_nogen_tomr']
...
df['diversity_hc1_equity_partners'] = df['hc1_eq_male_hisp'] + df['hc1_eq_male_black'] + df['hc1_eq_male_asian'] + df['hc1_eq_male_pi'] + df['hc1_eq_male_nata'] + df['hc1_eq_male_tomr'] + df['hc1_eq_fem_hisp'] + df['hc1_eq_fem_black'] + df['hc1_eq_fem_asian'] + df['hc1_eq_fem_pi'] + df['hc1_eq_fem_nata'] + df['hc1_eq_fem_tomr'] + df['hc1_eq_nb_hisp'] + df['hc1_eq_nb_black'] + df['hc1_eq_nb_asian'] + df['hc1_eq_nb_pi'] + df['hc1_eq_nb_nata'] + df['hc1_eq_nb_tomr'] + df['hc1_eq_nogen_hisp'] +
df['hc1_eq_nogen_black'] + df['hc1_eq_nogen_asian'] + df['hc1_eq_nogen_pi'] + df['hc1_eq_nogen_nata'] + df['hc1_eq_nogen_tomr']

df['diversity_hc1_equity_partners_proportion'] = df['diversity_hc1_equity_partners'] / df['total_hc1']

df['diversity_hc1_nonequity_partners'] = df['hc1_noneq_male_hisp'] + df['hc1_noneq_male_black'] + df['hc1_noneq_male_asian'] + df['hc1_noneq_male_pi'] + df['hc1_noneq_male_nata'] + df['hc1_noneq_male_tomr'] + df['hc1_noneq_fem_hisp'] + df['hc1_noneq_fem_black'] + df['hc1_noneq_fem_asian'] + df['hc1_noneq_fem_pi'] + df['hc1_noneq_fem_nata'] + df['hc1_noneq_fem_tomr'] + df['hc1_noneq_nb_hisp'] + df['hc1_noneq_nb_black'] + df['hc1_noneq_nb_asian'] + df['hc1_noneq_nb_pi'] + df['hc1_noneq_nb_nata']
+ df['hc1_noneq_nb_tomr'] + df['hc1_noneq_nogen_hisp'] + df['hc1_noneq_nogen_black'] + df['hc1_noneq_nogen_asian'] + df['hc1_noneq_nogen_pi'] + df['hc1_noneq_nogen_nata'] + df['hc1_noneq_nogen_tomr']

df['diversity_hc1_nonequity_partners_proportion'] = df['diversity_hc1_nonequity_partners'] / df['total_hc1']

df['diversity_hc1_associates'] = df['hc1_assoc_male_hisp'] + df['hc1_assoc_male_black'] + df['hc1_assoc_male_asian'] + df['hc1_assoc_male_pi'] + df['hc1_assoc_male_nata'] + df['hc1_assoc_male_tomr'] + df['hc1_assoc_fem_hisp'] + df['hc1_assoc_fem_black'] + df['hc1_assoc_fem_asian'] + df['hc1_assoc_fem_pi'] + df['hc1_assoc_fem_nata'] + df['hc1_assoc_fem_tomr'] + df['hc1_assoc_nb_hisp'] + df['hc1_assoc_nb_black'] + df['hc1_assoc_nb_asian'] + df['hc1_assoc_nb_pi'] + df['hc1_assoc_nb_nata'] +
df['hc1_assoc_nb_tomr'] + df['hc1_assoc_nogen_hisp'] + df['hc1_assoc_nogen_black'] + df['hc1_assoc_nogen_asian'] + df['hc1_assoc_nogen_pi'] + df['hc1_assoc_nogen_nata'] + df['hc1_assoc_nogen_tomr']
